# Generated by Powerlevel10k configuration wizard on 2021-06-04 at 11:45 MSK.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=4
  ...
  typeset -g POWERLEVEL9K_RANGER_BACKGROUND=6
  # Custom icon.
